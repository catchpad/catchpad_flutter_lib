...
_$_AccInterruptConfigModel _$$_AccInterruptConfigModelFromJson(
    ...
    _$_AccInterruptConfigModel(
      ...
      sleepEnable: json['sleepEnable'] as bool?,
    );

Map<String, dynamic> _$$_AccInterruptConfigModelToJson(
        _$_AccInterruptConfigModel instance) =>
    <String, dynamic>{
